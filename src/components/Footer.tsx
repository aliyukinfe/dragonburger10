...
export default function Footer() {
  return (
    <footer className="bg-dragon-black border-t border-orange-900/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/menu" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Menu
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-gray-400">
                ...
                <span>123 Dragon Street, Addis Ababa, Ethiopia</span>
              </li>
              <li className="flex items-center space-x-2 text-gray-400">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              ...
              <span className="text-orange-500 font-semibold">DragonTech</span>
            </div>
          </div>
        </div>
      </div>
