          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex space-x-3">
              {[
                ...
                <a key={i} href="#" className="w-9 h-9 glass rounded-lg flex items-center justify-center text-cyber-muted hover:text-neon-cyan hover:border-neon-cyan/30 transition-all">
